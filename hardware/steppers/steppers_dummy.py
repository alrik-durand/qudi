...
class SteppersDummy(Base, SteppersInterface):
    """ Dummy module for the steppers interface

    This module use internal function to be able to accept one or multiple axis identifier for a more user
    ...
    def _connect(self, attempt=7):
        """   Connect to the dummy instrument
        """
        self.connected = True

    def _disconnect(self, keep_active=False):
        """ Close connection with the instrument after setting all axis to ground (except if keep_active is true)
        """
