...
class AttoCubeStepper(Base, SteppersInterface):
    """ Hardware module to use the attocube controller ANC300 to interface steppers
    ...
    def _check_axis(self):
        """ Check that the axis in the config file are ok and complete them with default
        """
