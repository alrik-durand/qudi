...
"""
This file contains the Qudi Interfuse between a laser interface and PID control.
...
class Interfuse(GenericLogic, SimpleLaserInterface):
    ...
    pid = Connector(interface='PIDControllerInterface')

    # laser interface needs a maximum, pid does not really care if the set_point is unreachable
    _max_power = ConfigOption('max_power', missing='error')  # power in Watt
    ...
    def get_power(self):
        ...
        """
        return self._pid.get_process_value()
    ...
    def set_power(self, power):
        ...
        if mini <= power <= maxi:
            ...
            if self._laser_on == LaserState.ON:
                self._pid.set_setpoint(power)
            else:
                self._pid.set_setpoint(0)
        return self._power
    ...
    def get_current(self):
        ...
        """
        return self.get_power() / self.get_power_range()[1]*100
    ...
    def get_current_setpoint(self):
        ...
        """
        return self.get_power_setpoint() / self.get_power_range()[1]*100
    ...
    def set_current(self, current):
        ...
        """
        return self.set_power(self._max_power * current/100)
